...
class CEAFSystem:
    ...
    def __init__(self, config: Dict[str, Any], agent_manager: 'AgentManager', db_repo: 'AgentRepository'):
        ...
        self.mcl = MCLEngine(config=mcl_config, agent_config=self.config, lcam_module=self.lcam,
    ...
    async def generate_proactive_message(self, dominant_drive: str) -> Optional[str]:
        ...
        **Sua mensagem para o usuário:**
        ...
        try:
            model_to_use = LLM_MODEL_SMART  # Ou LLM_MODEL_FAST, dependendo da sua lógica atual
    ...
    async def process(self, query: str, session_id: str,
        ...
        if chat_history and len(chat_history) > CONTEXT_COMPACTION_THRESHOLD:
            ...
            try:
                ...
                summary = await self.llm_service.ainvoke(LLM_MODEL_FAST, summary_prompt, max_tokens=350)
