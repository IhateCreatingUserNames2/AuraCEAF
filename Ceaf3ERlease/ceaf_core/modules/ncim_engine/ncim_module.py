    ...
    async def update_identity(
        ...
        if body_state and body_state.cognitive_fatigue > 0.6:
            additional_context_prompt = f"""
                **Contexto Adicional do Estado Interno:**
                - No final desta interação, o agente registrou uma fadiga cognitiva alta ({body_state.cognitive_fatigue:.2f}). O que essa experiência de 'cansaço' revela sobre suas capacidades ou limitações ao lidar com este tipo de tópico?
                """
